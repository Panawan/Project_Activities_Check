      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body table-responsive">
                  <form action="<?php echo site_url('InsertClass/addclass');?>" method="post" >
                    <div class="form-group">
                      <label for="s_name">ชื่อห้อง:</label>
                      <input type="text" class="form-control" name="s_name" placeholder="Enter Class Name">
                    </div>
                    <div class="form-group">
                      <label for="ref_teacher_id">รหัสของอาจารย์ประจำห้อง:</label>
                      <input type="text" class="form-control" name="ref_teacher_id" placeholder="Enter Teacher_id as a reference">
                    </div>
