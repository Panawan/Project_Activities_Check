      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body table-responsive">
                  <form action="<?php echo site_url('teacher/updatePasswordToDB');?>" method="post" >
                    <div class="form-group">
                      <label for="teacher_prefix">คำนำหน้า:</label>
                      <input type="text" class="form-control" name="teacher_prefix" placeholder="Enter Prefix" value="<?= $rseditProfile->teacher_prefix; ?>" disabled>
                    </div>
                    <div class="form-group">
                      <label for="teacher_firstname">ชื่อของอาจารย์:</label>
                      <input type="text" class="form-control" name="teacher_firstname" placeholder="Enter Teacher FirstName" value="<?= $rseditProfile->teacher_firstname; ?>" disabled>
                    </div>
                    <div class="form-group">
                      <label for="teacher_lastname">นามสกุลของอาจารย์:</label>
                      <input type="text" class="form-control" name="teacher_lastname" placeholder="Enter Teacher LastName" value="<?= $rseditProfile->teacher_lastname; ?>" disabled>
                    </div>
                    <div class="form-group">
                      <label for="username">username:</label>
                      <input type="text" class="form-control" name="username" placeholder="Enter Username" value="<?= $rseditProfile->username; ?>" disabled>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="password2" placeholder="Confirm Your Password" required>
                    </div>
